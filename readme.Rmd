...
author: "Ben Sabath, Lucas Henneman (edited 6 Dec, 2021)"
date: "04/10/2019"
...
you created locally (make sure to not include the
readme.md option that github suggests) for your project. 
We recommend using github, as you can
...
project. In RStudio, go to `File > New Project`, then follow the prompts to 
create a project in an existing directory. When asked, choose the "Existing
Directory" option, then browse to the `<NEW_PROJECT_NAME>` directory and complete
the directions.
